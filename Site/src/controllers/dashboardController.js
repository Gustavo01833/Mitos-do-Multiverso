...
function pegarSistemasMaisFavoritados(req, res) {
        ...
        dashboardModel.sistemasMaisFavoritados()
            .then(
                ...
                function (erro) {
                    console.log(erro);
                    console.log("\nHouve um erro ao realizar a busca de favoritos! Erro: ", erro.sqlMessage);
...
function pegarCadastros6meses(req, res) {
        ...
        dashboardModel.cadastros6meses()
            .then(
                function (resultadoBusca) {
                    console.log(`\nResultados encontrados: ${resultadoBusca.length}`);
                ...
                function (erro) {
                    console.log(erro);
                    console.log("\nHouve um erro ao realizar a busca de cadastro dos últimos meses! Erro: ", erro.sqlMessage);
                    res.status(500).json(erro.sqlMessage);
                }
            );
